...
# weight 2 and bias 2
w2 = tf.Variable(tf.random_normal([HIDDEN_SIZE, CLASS_NUMBER]))
b2 = tf.Variable(tf.random_normal([CLASS_NUMBER]))
...
# Gradient Descent using momentum algorithm
...
# Confusion matrix for calculate TPR and FPR
